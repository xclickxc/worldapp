...
import 'package:flutter_custom_clippers/src/wave_clipper_1.dart';
          ...
          ClipPath(
            ...
            child: Image(
              image: appState.firebaseUser.photoUrl == null
                  ? AssetImage("assets/imageProfile/account.png")
                          ...
                          builder: (BuildContext context)
                          {
                            return AlertDialog(
                              ...
                              actions: <Widget>[
                                ...
                                FlatButton(
                                  onPressed: (){StateWidget.of(context).signOut(); Navigator.pop(context);},
                                  child: Text(
                                    "Logout",
                                    style: TextStyle(
                                      fontSize: 20.0
